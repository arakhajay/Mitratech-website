...
export const COMPANY_INFO = {
  ...
  aboutShort:
    "Mitratech Services (OPC) Pvt Ltd is a modern software development and digital marketing agency that helps startups, SMEs, and enterprises build powerful digital products, improve their online presence, and generate measurable business growth.",
  aboutLong:
    "Founded with a vision to bridge the gap between high-end digital engineering and strategic brand growth, Mitratech Services (OPC) Pvt Ltd combines elite UI/UX design, modern full-stack web applications, and hyper-targeted digital marketing campaigns. Our multidisciplinary team works with ambition-driven companies worldwide to deliver software that scales effortlessly and drives real ROI.",
  stats: [
  ...
  timeline: [
    { year: "2020", title: "Agency Founded", description: "Mitratech Services (OPC) Pvt Ltd started as a boutique design studio serving tech startups." },
