            ...
            <div className="space-y-4 text-xs sm:text-sm">
              ...
              <div className="flex items-center space-x-3.5">
                ...
                <div>
                  ...
                  <a href={COMPANY_INFO.contact.telLink} className="text-slate-300 hover:text-cyan-400 transition-colors">
              ...
              <div className="flex items-center space-x-3.5">
                ...
                <div>
                  ...
                  <a href={`mailto:${COMPANY_INFO.contact.email}`} className="text-cyan-400 hover:underline">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Web Application Development">Web Application (SaaS / AI)</option>
                ...
                <div>
                  ...
                  <textarea
                    {...register("message")}
                    rows={4}
                    placeholder="Describe your project vision, target timeline, or requirements..."
                    className="w-full px-3.5 py-2.5 rounded-xl bg-slate-800/80 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 text-sm"
                  />
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-bold text-sm shadow-xl shadow-blue-500/25 flex items-center justify-center space-x-2 transition-all active:scale-95 disabled:opacity-50 cursor-pointer"
                >
                  {isSubmitting ? (
